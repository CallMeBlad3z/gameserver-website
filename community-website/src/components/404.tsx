...
export default function Nowhere() {
    return (
        <div className="flex items-center justify-center h-screen bg-red-dark">
            <div className="p-8 shadow-2xl rounded bg-red">
                <div className="flex flex-row items-center justify-center space-x-10">
                    <div className="flex flex-col items-center justify-center">
                        <h1 className="text-4xl font-bold text-white ">404 - Sivua ei löytynyt</h1>
                    </div>
                    <Image
                        src={jantteriImg}
                        alt="jantteri"
